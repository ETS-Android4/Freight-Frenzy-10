...
public class BlueWarehouse extends LinearOpMode {
    ...
    public static Pose2d START_POSE = new Pose2d(5.0, 64.0, Math.PI/2);
    public static Pose2d WAREHOUSE_POSE = new Pose2d(52, 56,0);

//    public static double SCORE_ANGLE = -2 * Math.PI / 3;
    public static double SCORE_ANGLE = Math.toRadians(-100);
    public static double SCORE_DISTANCE = 29.5;
