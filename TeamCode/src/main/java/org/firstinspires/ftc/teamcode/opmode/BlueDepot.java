...
public class BlueDepot extends LinearOpMode {
    ...
    public static Pose2d START_POSE = new Pose2d(-32.0, 63.0, Math.PI/2);
    public static Pose2d DEPOT_POSE = new Pose2d(-60, 39,Math.PI);
    ...
    private Pose2d SCORE_POSE = new Pose2d(
            AutoConstants.BLUE_SHIPPING_HUB.getX() - SCORE_DISTANCE * Math.cos(SCORE_ANGLE),
            AutoConstants.BLUE_SHIPPING_HUB.getY() - SCORE_DISTANCE * Math.sin(SCORE_ANGLE),
            SCORE_ANGLE
    );
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory parkTraj = drive.trajectoryBuilder(SCORE_POSE.plus(new Pose2d(0,0,Math.PI)))
                .splineTo(DEPOT_POSE.vec(),DEPOT_POSE.getHeading())
